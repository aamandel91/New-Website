...
describe('#parseAddress', function () {
  ...
  it('should parse a street address with a state name', function () {
    var result = addresser.parseAddress(
      '123 Main  St, Conway, South Carolina 29526-3131'
    )
    expect(result.streetNumber).to.equal('123')
    expect(result.streetName).to.equal('Main')
    expect(result.streetSuffix).to.equal('St')
  ...
  it('should parse a street address with a lowercase state abbeviation', function () {
    var result = addresser.parseAddress(
      '123 Main  St, San Antonio, tx 29526-3131'
    )
    expect(result.streetNumber).to.equal('123')
    expect(result.streetName).to.equal('Main')
    expect(result.streetSuffix).to.equal('St')
  ...
  it('should parse a street address with a delimited zip code', function () {
    var result = addresser.parseAddress(
      '123 Main  St, Canyon Lake, tx, 29526-3131'
    )
    expect(result.streetNumber).to.equal('123')
    expect(result.streetName).to.equal('Main')
    expect(result.streetSuffix).to.equal('St')
  ...
  it('should not parse a street address with missing city and state', function () {
    expect(
      addresser.parseAddress.bind(addresser.parseAddress, '123 Main  St')
    ).to.throw('Can not parse address.')
  })
  it('should validate input is not undefined', function () {
    expect(addresser.parseAddress.bind(addresser.parseAddress)).to.throw(
  ...
  it('should not parse an invalid state abbreviation', function () {
    expect(
      addresser.parseAddress.bind(
        addresser.parseAddress,
        '123 Main St, Canyon Lake, XX, 29526-3131'
      )
    ).to.throw('Can not parse address.')
  })
  ...
  it('should parse an address with a secondary value on same section with city', function () {
    var result = addresser.parseAddress(
      '1301 Columbia College Drive Unit 101 Columbia, SC 29203'
    )
    expect(result.streetNumber).to.equal('1301')
    expect(result.streetName).to.equal('Columbia College')
    expect(result.streetSuffix).to.equal('Dr')
  ...
  it('should parse an address with a secondary value on separate line', function () {
    var result = addresser.parseAddress(
      '1301 Columbia College Drive, APT A, Columbia, SC 29203'
    )
    expect(result.streetNumber).to.equal('1301')
    expect(result.streetName).to.equal('Columbia College')
    expect(result.streetSuffix).to.equal('Dr')
  ...
  it('should parse an address with a direction following the street type', function () {
    var result = addresser.parseAddress(
      '1301 Acme Street E, Columbia, SC 29203'
    )
    expect(result.streetNumber).to.equal('1301')
  ...
  it('should parse an address with line 2 incorrectly placed before line 1', function () {
    var result = addresser.parseAddress(
      'UNIT 101, 1301 Acme Street E, Columbia, SC 29203'
    )
    expect(result.streetNumber).to.equal('1301')
    expect(result.streetName).to.equal('Acme')
    expect(result.streetSuffix).to.equal('St')
  ...
  it('should parse an address with secondary address at the beginning of line 1', function () {
    var result = addresser.parseAddress(
      'UNIT 101, 1301 Acme Avenue, Columbia, SC 29203'
    )
    expect(result.streetNumber).to.equal('1301')
    expect(result.streetName).to.equal('Acme')
    expect(result.streetSuffix).to.equal('Ave')
  ...
  it('should parse an address with a trailing country', function () {
    var result = addresser.parseAddress(
      '300 BOYLSTON AVE, SEATTLE WA 98102, USA'
    )
    expect(result.streetNumber).to.equal('300')
    expect(result.streetName).to.equal('Boylston')
    expect(result.streetSuffix).to.equal('Ave')
  ...
  it('should provide an id for a valid address with second address line', function () {
    var result = addresser.parseAddress(
      '123 Main St Unit 101, Conway, SC 29526'
    )
    expect(result.addressLine1).to.equal('123 Main St')
    expect(result.addressLine2).to.equal('Unit 101')
  ...
  it('should parse a street address with "Ave. b" style street name with non delimited second address line', function () {
    var result = addresser.parseAddress(
      '826 N Ave. b Unit 101, Crowley, LA 70526'
    )
    expect(result.streetNumber).to.equal('826')
    expect(result.streetName).to.equal('N Ave B')
    expect(result).to.not.have.property('streetSuffix')
  ...
  it('should parse a street address without a normal suffix like 123 Texas Gold', function () {
    var result = addresser.parseAddress(
      '12939 Texas Gold, San Antonio, TX 78253'
    )
  ...
  it('should parse a street address without a normal suffix and 2nd address line like 123 Texas Gold Unit 101', function () {
    var result = addresser.parseAddress(
      '12939 Texas Gold Unit 101, San Antonio, TX 78253'
    )
    expect(result.streetNumber).to.equal('12939')
    expect(result.streetName).to.equal('Texas Gold')
    expect(result).to.not.have.property('streetSuffix')
  ...
  it('should parse an Interstate address with a # unit', function () {
    var result = addresser.parseAddress(
      '10701 S Interstate 35 # 35, Austin, TX'
    )
  ...
  it('should parse "67A Alameda De Las Pulgas style address', function () {
    var result = addresser.parseAddress(
      '67A Alameda De Las Pulgas, Redwood City, CA 94062'
    )
  ...
  it('should parse "630A Pinellas Bwy S Apt 3202 style address', function () {
    var result = addresser.parseAddress(
      '630A Pinellas Bwy S Apt 3202, Saint Petersburg, FL 33715'
    )
  ...
  it('should parse "24497A Tupelo Sr style address', function () {
    var result = addresser.parseAddress(
      '24497A Tupelo Sr, Saint Robert, MO 65584'
    )
  ...
  it('should parse North Chesterfield city address with Turn suffix', function () {
    var result = addresser.parseAddress(
      '1300 Providence Ridge Turn, North Chesterfield, VA 23236'
    )
  ...
  it('should parse North Chesterfield city address with Apartment line 2', function () {
    var result = addresser.parseAddress(
      '5210 Castlewood Rd Apt E, North Chesterfield, VA 23234'
    )
  ...
  it('should parse Oberlin city address', function () {
    var result = addresser.parseAddress(
      '186 N Harrisburg St Apt 3, Oberlin, PA 17113'
    )
  ...
  it('should parse West Reading city address', function () {
    var result = addresser.parseAddress(
      '400 Franklin St Apt 205, West Reading, PA 19611'
    )
    expect(result.streetNumber).to.equal('400')
  ...
  it('should parse West Pittston city address', function () {
    var result = addresser.parseAddress(
      '315 Salem St Apt A, West Pittston, PA 18643'
    )
  ...
  it('should parse Steelton city address', function () {
    var result = addresser.parseAddress(
      '485 State St Apt B, Steelton, PA 17113'
    )
  ...
  it('should parse East Cambridge city address', function () {
    var result = addresser.parseAddress(
      '11 Bristol St Apt 2, East Cambridge, MA 02141'
    )
  ...
  it('should parse a South Chesterfield city address', function () {
    var result = addresser.parseAddress(
      '19917 Oakland Ave Unit 1, South Chesterfield, VA 23834'
    )
  ...
  it('should parse a East Rochester city address', function () {
    var result = addresser.parseAddress(
      '802 Spruce St Unit A, East Rochester, PA 15074'
    )
  ...
  it('should parse a Spring Lake Park city address', function () {
    var result = addresser.parseAddress(
      '8070 Central Ave NE Unit 8070-206, Spring Lake Park, MN 55432'
    )
  ...
  it('should return a formattedAddress field', function () {
    ...
    expect(result.addressLine1).to.equal('12939 Texas Gold')
    expect(result).to.not.have.property('addressLine2')
    expect(result.formattedAddress).to.equal(
      '12939 Texas Gold, San Antonio, TX 78253'
    )
    expect(result.placeName).to.equal('San Antonio')
    expect(result.stateAbbreviation).to.equal('TX')
  ...
  it('should return a formattedAddress field when a second address line is provided', function () {
    var result = addresser.parseAddress(
      '12939 Live Oak Street Unit 101, San Antonio, TX 78253'
    )
    expect(result.streetNumber).to.equal('12939')
    ...
    expect(result.addressLine2).to.equal('Unit 101')
    expect(result.formattedAddress).to.equal(
      '12939 Live Oak St, Unit 101, San Antonio, TX 78253'
    )
    expect(result.placeName).to.equal('San Antonio')
    expect(result.stateAbbreviation).to.equal('TX')
    expect(result.stateName).to.equal('Texas')
  ...
  it('should parse a simple Canadian Address with Trailing Country', function () {
    var result = addresser.parseAddress(
      '123 Main St, Toronto, ON M3K5K9, Canada'
    )
    expect(result.streetNumber).to.equal('123')
    expect(result.streetName).to.equal('Main')
    expect(result.streetSuffix).to.equal('Street')
    expect(result.hasOwnProperty('streetDirection')).to.equal(false)
    expect(result.addressLine1).to.equal('123 Main Street')
    expect(result.hasOwnProperty('addressLine2')).to.equal(false)
    expect(result.placeName).to.equal('Toronto')
    expect(result.stateAbbreviation).to.equal('ON')
    expect(result.stateName).to.equal('Ontario')
...
describe('##cities', function () {
  it('should provide a full list of cities', function () {
    ...
    expect(result['TX'].includes('ThisCityCannot143234234234234PossiblyExist'))
      .to.be.false
  })
})
...
describe('Extra canada', function () {
  ...
  it('should parse a simple Canadian Address with 2-letter Street Direction', function () {
    var result = addresser.parseAddress(
      '310 8 Street SW, Calgary, Alberta T2P 3P3, Canada'
    )
    expect(result.streetNumber).to.equal('310')
    expect(result.streetName).to.equal('8')
    expect(result.streetSuffix).to.equal('Street')
    expect(result.streetDirection).to.equal('SW')
    expect(result.addressLine1).to.equal('310 8 Street SW')
    expect(result.hasOwnProperty('addressLine2')).to.equal(false)
    expect(result.placeName).to.equal('Calgary')
    expect(result.stateAbbreviation).to.equal('AB')
    expect(result.stateName).to.equal('Alberta')
  ...
  it('should parse a simple Canadian Address with 1-letter Street Direction', function () {
    var result = addresser.parseAddress(
      '310 8 Street N, Calgary, Alberta T2P 3P3, Canada'
    )
    expect(result.streetNumber).to.equal('310')
    expect(result.streetName).to.equal('8')
    expect(result.streetSuffix).to.equal('Street')
  ...
  it('should parse a simple Canadian Address with Full word Street Direction', function () {
    var result = addresser.parseAddress(
      '310 8 Street Southwest, Calgary, Alberta T2P 3P3, Canada'
    )
    expect(result.streetNumber).to.equal('310')
    expect(result.streetName).to.equal('8')
    expect(result.streetSuffix).to.equal('Street')
  ...
  it('should parse a simple Canadian Address with Full word Street Direction without ZipCode', function () {
    var result = addresser.parseAddress(
      '310 8 Street Southwest, Calgary, Alberta, Canada'
    )
    expect(result.streetNumber).to.equal('310')
    expect(result.streetName).to.equal('8')
    expect(result.streetSuffix).to.equal('Street')
  ...
  it('should parse a simple Canadian Address with Canadian street type', function () {
    var result = addresser.parseAddress(
      '310 Main Private, Calgary, Alberta T2P 3P3, Canada'
    )
    expect(result.streetNumber).to.equal('310')
    expect(result.streetName).to.equal('Main')
  ...
  it('should parse a simple Canadian Address with southeast street direction', function () {
    var result = addresser.parseAddress(
      '508 7 Avenue Southeast, Calgary, AB, Canada'
    )
    expect(result.streetNumber).to.equal('508')
    expect(result.streetName).to.equal('7')
    expect(result.streetSuffix).to.equal('Avenue')
    expect(result.streetDirection).to.equal('SE')
    expect(result.addressLine1).to.equal('508 7 Avenue SE')
    expect(result.hasOwnProperty('addressLine2')).to.equal(false)
    expect(result.placeName).to.equal('Calgary')
    expect(result.stateAbbreviation).to.equal('AB')
  })
  ...
  it('should parse a simple Canadian Address with any-case southeast street direction', function () {
    var result = addresser.parseAddress(
      '508 Queens dr SoUthEaSt, Calgary, AB, Canada'
    )
    expect(result.streetNumber).to.equal('508')
  ...
  it('should parse a simple Canadian Address with any-case street direction - North East', function () {
    var result = addresser.parseAddress(
      '508 Queens dr North East, Calgary, AB, Canada'
    )
    expect(result.streetNumber).to.equal('508')
    expect(result.streetName).to.equal('Queens')
    expect(result.streetSuffix).to.equal('Drive')
  ...
  it('should parse a simple Canadian Address with Ln and SW street direction', function () {
    var result = addresser.parseAddress(
      '15 Signal Hill Ln SW, Calgary, AB, Canada'
    )
  ...
  it('should parse a simple Canadian Address with Pvt and SW street direction', function () {
    var result = addresser.parseAddress(
      '15 Signal Hill Pvt SW, Calgary, AB, Canada'
    )
    expect(result.streetNumber).to.equal('15')
    expect(result.streetName).to.equal('Signal Hill')
    expect(result.streetSuffix).to.equal('Private')
