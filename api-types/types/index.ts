...
export const YesNoValues = ['Y', 'N'] as const
export type YesNo = (typeof YesNoValues)[number]

export const ClassValues = ['condo', 'residential', 'commercial'] as const
...
export const OperatorValues = ['AND', 'OR'] as const
...
export const StatusValues = ['A', 'U'] as const
export type Status = (typeof StatusValues)[number]

export const TypeValues = ['sale', 'lease'] as const
