...
const config: AppConfig = {
  ...
  app: {
    ...
    cors: {
      validDomains: [
        ...
        ...(process.env['APP_CORS_DOMAIN'] || 'http://localhost:3000').split(
          ','
        )
      ]
    }
  ...
  repliers: {
    ...
    estimatesNotificationSettings: {
      sendEmailNow:
        typeof process.env['REPLIERS_ESTIMATES_SEND_EMAIL_NOW'] !== 'undefined'
          ? process.env[
  ...
  boss: {
    ...
    webhook: {
      ...
      base_url:
        process.env['BOSS_WEBHOOK_BASEURL'] || 'https://localhost:3000/webhook',
  ...
  settings: {
    ...
    scrubbing_duplicates_enabled:
      process.env['SETTINGS_SCRUBBING_PROCESS_DUPLICATES_ENABLED'] !== 'false',
