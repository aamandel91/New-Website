...
declare module 'knex/types/tables.js' {
  ...
  export type PeopleSyncTableRequired =
    | 'sync_id'
    | 'payload'
    | 'user_id'
    | 'people_id'
    | 'agent_id'
    | 'status'
  export type PeopleSyncTableInsert = Partial<PeopleSyncTable> &
    Pick<PeopleSyncTable, PeopleSyncTableRequired>
  interface Tables {
    people_sync: PeopleSyncTable
    people_sync_composite: Knex.CompositeTableType<
      PeopleSyncTable,
      // for select
