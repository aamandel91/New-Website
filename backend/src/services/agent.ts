...
import {
  AgentCreateClientDto,
  AgentCreateEstimateDto,
  AgentCreateMessageDto,
  AgentGetBossPeopleDto,
  AgentGetClientsDto,
  AgentGetEstimateDto,
  AgentGetMessagesDto,
  AgentSendEstimateDto,
  AgentUpdateClientDto,
  AgentUpdateEstimateDto
...
export default class AgentService {
  constructor(
    ...
    private repliersEstimates: RepliersEstimate,
    private repliersMessages: RepliersMessages,
    private boss: BossService,
    // by @sokol8: TEMP COMMENT TO MAKE THINGS BUILD
    private syncRepo: SyncRepository,
    private peopleSyncRepo: PeopleSyncRepository,
  ...
  async checkSignature(
    ...
    const expectedSignature = calcSignature(
      clientId,
