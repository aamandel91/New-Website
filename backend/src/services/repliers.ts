...
export default class RepliersService {
  constructor(
    public listings: RepliersListings,
    public messages: RepliersMessages,
    public clients: RepliersClients,
    public favorites: RepliersFavorites,
    public searches: RepliersSearches,
    public estimate: RepliersEstimate,
    public agents: RepliersAgents
  ) {}
}
