...
export type RplRollingPeriodName =
  | 'grp-30-days'
  | 'grp-90-days'
  | 'grp-365-days'
...
export interface RplListingsSearchRequest
  extends Omit<RplListingsSearchDto, 'app_state'>,
    ApiRequest {}
...
export interface RplListingsSimilarRequest
  extends RplListingsSimilarDto,
    ApiRequest {}
export interface RplListingsSimilarResponse extends ApiResponse {}
export interface RplListingsSingleRequest
  extends RplListingsSingleDto,
    ApiRequest {}
export interface RplListingsSingleResponse
  extends ApiResponse,
    RplListingsSingle {}
export interface RplListingsLocationsRequest
  extends Omit<RplListingsLocationsDto, 'dropCoordinates'>,
    ApiRequest {}
...
export default class RepliersListings extends RepliersBase {
  public search(params: RplListingsSearchRequest, usePost = false) {
    ...
    return this.request<RplListingsSearchResponse>(
      usePost ? 'POST' : 'GET',
      '/listings',
      query,
      body
  ...
  public similar(params: RplListingsSimilarRequest) {
    const { propertyId, ...otherParams } = params
    return this.request<RplListingsSimilarResponse>(
      'GET',
  ...
  public locations(params: RplListingsLocationsRequest) {
    return this.request<RplListingsLocationsResponse>(
      'GET',
      `/listings/locations`,
      params
    )
  ...
  public single(params: RplListingsSingleDto) {
    const { mlsNumber, ...otherParams } = params
    return this.request<RplListingsSingleResponse>(
      'GET',
      `/listings/${mlsNumber}`,
      otherParams
    )
