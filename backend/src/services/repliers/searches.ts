...
export interface RplSearchesCreateRequest
  extends RplSearchesCreateDto,
    ApiRequest {}
...
export interface RplSearchesUpdateRequest
  extends RplSearchesUpdateDto,
    ApiRequest {}
export interface RplSearchesUpdateResponse extends ApiResponse {}
export interface RepliersSearchesFilterDto {
  clientId: number
}
export interface RplSearchesFilterRequest
  extends RepliersSearchesFilterDto,
    ApiRequest {}
...
export default class RepliersSearches extends RepliersBase {
  create(params: RplSearchesCreateRequest) {
    return this.request<RplSearchesCreateResponse>(
      'POST',
      `/searches`,
      {},
      params
  ...
  update(params: RplSearchesUpdateRequest) {
    ...
    return this.request<RplSearchesUpdateResponse>(
      'PATCH',
      `/searches/${searchId}`,
      {},
      updates
  ...
  delete(searchId: number) {
    return this.request<RplSearchesDeleteResponse>(
      'DELETE',
      `/searches/${searchId}`
    )
  }
