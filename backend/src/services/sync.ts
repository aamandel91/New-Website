...
export default class SyncService {
  constructor(
    ...
    private readonly peopleSyncRepository: PeopleSyncRepository,
    private readonly repliersClients: RepliersClients,
  ...
  async publishUpsert(id: number, payload: PeopleSyncPayload) {
    ...
    return jsc.publish(
      `${this.config.nats.worker.consumer_stream}.people.upsert`,
      JSON.stringify({
        id,
        payload
      })
