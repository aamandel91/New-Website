...
export class BossPeopleWorker extends StreamWorker {
  constructor(
    ...
    private bossWebhookService: BossWebhooksService,
    ...
    this.eventMap = new Map([
      [
        `${config.nats.worker.consumer_stream}.people.upsert`,
        this.handleUpsert.bind(this)
      ],
      [
        `${config.nats.worker.consumer_stream}.people.create`,
        this.handleWebhookCreate.bind(this)
      ],
      [
        `${config.nats.worker.consumer_stream}.people.update`,
        this.handleWebhookUpdate.bind(this)
      ],
      [
        `${config.nats.worker.consumer_stream}.people.delete`,
        this.handleWebhookDelete.bind(this)
      ]
    ])
  }
