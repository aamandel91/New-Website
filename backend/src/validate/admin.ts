...
export const adminCreateAgentSchema = joi.object<RplCreateAgentDto>(
  adminCreateAgentSchemaKeys
)
export const adminCreateAgentBatchSchema = joi
  .array()
  .items(joi.object<RplCreateAgentDto>(adminCreateAgentSchemaKeys))
export interface RplUpdateAgentDto extends Partial<RplCreateAgentDto> {
  agentId: number
}
export const adminUpdateAgentSchema = (
  adminCreateAgentSchema.fork(
    Object.keys(adminCreateAgentSchemaKeys),
    (schema) => schema.optional()
  ) as joi.ObjectSchema<RplUpdateAgentDto>
)
  .keys({
