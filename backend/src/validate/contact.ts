...
export type ContactContactUsDto =
  ...
  | ContactContactUsPolsinelloDto
export const contactContactusSchema =
  customValidators.contactContactusSchema ||
  joi.object<ContactContactUsDto>().keys({
...
export const contactScheduleSchema = joi.object<ContactScheduleDto>().keys({
  ...
  method: joi
    .string()
    .valid(...Object.values(ContactScheduleMethod))
    .required(),
...
export const contactScheduleEstimateSchema = joi
  .object<ContactEstimateScheduleDto>()
  .keys({
    name: contactNameSchema.required(),
    email: emailSchema.required(),
    phone: phoneSchema,
...
export const contactRequestInfoSchema = joi
  .object<ContactRequestInfoDto>()
  .keys({
    name: contactNameSchema.required(),
    email: emailSchema.required(),
    phone: phoneSchema.required(),
