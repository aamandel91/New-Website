...
export const statsNeighborhoodsrankingSchema = joi
  .object<StatsNeighborhoodsrankingDto>()
  .keys({
    ...
    sorting: joi
      .string()
      .valid('gainLowToHigh', 'gainHighToLow', 'avgHighToLow', 'avgLowToHigh')
      .default('gainHighToLow') // @see StatsNeighborhoodsrankingDto.sorting
  })
