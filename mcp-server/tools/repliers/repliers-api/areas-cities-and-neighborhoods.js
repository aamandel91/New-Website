...
const apiTool = {
  ...
  definition: {
    ...
    function: {
      name: 'list_locations',
      description:
        'List geographical location data such as areas, cities, and neighborhoods.',
      parameters: {
        type: 'object',
        properties: {
          area: {
            type: 'string',
            description:
              'Limits location metadata to areas matching the supplied value.'
          },
          city: {
            type: 'string',
            description:
              'Limits location metadata to cities matching the supplied value.'
          },
          class: {
            type: 'string',
            description:
              'Limits location metadata to classes matching the supplied value.'
          },
          neighborhood: {
            type: 'string',
            description:
              'Limits location metadata to neighborhoods matching the supplied value.'
          },
          search: {
            type: 'string',
            description:
              'Limits location metadata to areas, cities, or neighborhoods that match or partially match the supplied value.'
          }
        }
      }
    }
