          ...
          params: {
            ...
            properties: {
              ...
              neighborhood: {
                ...
                items: { type: 'string' },
                description:
                  'Filter by one or more geographical neighborhoods that the building is situated in'
              },
              ...
              displayPublic: {
                ...
                enum: ['Y', 'N'],
                description:
                  'Y = publicly displayable buildings, N = password protected buildings. If not specified, returns both'
              }
            }
          },
          pageNum: {
            ...
            minimum: 1,
            description:
              'Page number for pagination (default: 1). If specified loads a specific page in the results set'
          },
          resultsPerPage: {
            type: 'number',
            minimum: 1,
            maximum: 100,
            description:
              'Number of buildings to return per page (default: 100, max: 100)'
          }
        },
        required: []
      }
