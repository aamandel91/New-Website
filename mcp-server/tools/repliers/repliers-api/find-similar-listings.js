      ...
      parameters: {
        ...
        properties: {
          mlsNumber: {
            type: 'string',
            description:
              'The MLS number of the listing to find similar listings for.'
          },
          boardId: {
            type: 'array',
            items: {
          ...
          fields: {
            type: 'string',
            description:
              'Limit the response to specific fields (e.g., "listPrice,soldPrice" or "images[5]").'
          },
          listPriceRange: {
            type: 'number',
            description:
              'Returns similar listings within a price range (e.g., 250000 for +/- $250,000).'
          },
          radius: {
            type: 'number',
            description:
              'Show similar listings within a specified radius in kilometers.'
          },
          sortBy: {
            type: 'string',
            description:
              'Sort similar listings by a specific field (e.g., "updatedOnDesc", "createdOnAsc").',
            enum: [
              'updatedOnDesc',
              'updatedOnAsc',
              'createdOnAsc',
