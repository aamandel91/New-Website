...
export interface MapFilters {
  ...
  activeListingDays?:
    ...
    | '30+'
    | '60+'
    | '90+' // Active listing date filter (undefined = off)
  soldListingDays?:
    | '1'
    | '3'
    | '7'
    ...
    | '2009'
    | '2008'
    | '2007' // Sold listing date filter (undefined = off)
  unavailableListingDays?:
    | '1'
    | '3'
    | '7'
    | '30'
    ...
    | '2009'
    | '2008'
    | '2007' // Unavailable listing date filter (undefined = off)
}
