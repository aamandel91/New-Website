    ...
    <Box>
      ...
      >
        <Container maxWidth="md">
          ...
          >
            {tenant.brand.teamName} — We are South Floridians – born &amp;
            raised.
          </Typography>
        </Container>
      </Box>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 6, md: 10 } }}>
        <PageWithSidebar sidebar={<InfoPageSidebar />}>
          ...
          <Box sx={{ textAlign: 'center', mb: 6 }}>
            ...
            >
              {tenant.brand.teamName} has been helping families buy and sell
              homes across South Florida for years. We pride ourselves on our
              deep knowledge of the local market, our unwavering commitment to
              our clients, and our results-driven approach. Whether you&apos;re
              buying your first home or selling a luxury estate, we have the
              expertise and passion to guide you every step of the way.
            </Typography>
          </Box>
