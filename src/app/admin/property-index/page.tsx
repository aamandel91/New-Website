...
export default function PropertyIndexPage() {
  ...
  const loadIndex = useCallback(async () => {
    ...
    try {
      ...
      // Just load the index file via a lightweight request
      // Actually, we'll load the index directly from the backfill endpoint
    } catch {
      // ignore - stats will be empty
    }

    // Load property index via internal fetch
    try {
