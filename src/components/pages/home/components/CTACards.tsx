...
const CTA_ITEMS = [
  {
    ...
    description:
      'Find the value of your home based on the latest market data and comparable sales.',
  ...
  },
  {
    ...
    description:
      'Schedule a one on one meeting with us to discuss your real estate goals.',
  ...
  },
  {
    ...
    description:
      'We will sell your home faster and for a better price with our proven marketing strategies.',
