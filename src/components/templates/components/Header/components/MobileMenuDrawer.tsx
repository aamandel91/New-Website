  ...
  return (
    ...
    >
      <Box sx={{ p: 3 }}>
        ...
        <Stack spacing={0.5}>
          <Link href="/search/advanced" onClick={onClose} sx={MOBILE_LINK_SX}>
            Search
          </Link>

          <Link href="/ai-search" onClick={onClose} sx={MOBILE_LINK_SX}>
            AI Search
          </Link>
          ...
          <Link href="/sell" onClick={onClose} sx={MOBILE_LINK_SX}>
            Sell
          </Link>
          ...
          <Link href="/blog" onClick={onClose} sx={MOBILE_LINK_SX}>
            Blog
          </Link>
        </Stack>
      </Box>
