...
const { groups } = sections.hoaLocationSchools

const hoaLocationSchoolsResolver = (property: Property) => {
  try {
    ...
    console.error(
      '[hoaLocationSchoolsResolver]: Error resolving section properties.',
      error
    )
    return []
  }
...
export default hoaLocationSchoolsResolver
