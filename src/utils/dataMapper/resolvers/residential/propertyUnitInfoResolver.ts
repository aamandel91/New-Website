...
const { groups } = sections.propertyUnitInfo

const propertyUnitInfoResolver = (property: Property) => {
  try {
    ...
    console.error(
      '[propertyUnitInfoResolver]: Error resolving section properties.',
      error
    )
    return []
  }
...
export default propertyUnitInfoResolver
